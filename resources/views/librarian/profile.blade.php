...
.avatar-initials { font-size:2.2rem; font-weight:700; color:#8884a8; font-family:'Outfit',sans-serif; }
...
<div class="content-card">
    ...
    <div class="profile-body">
        ...
        <div class="avatar-col">
            ...
            <form method="POST" action="{{ route('librarian.profile.photo') }}" enctype="multipart/form-data" style="width:100%;">
                @csrf @method('PUT')
        ...
        <div>
            <div class="info-section">
                ...
                <table class="info-table">
                    ...
                    <tr><td>Role</td>       <td>Librarian</td></tr>
